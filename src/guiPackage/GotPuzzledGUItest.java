...
public class GotPuzzledGUItest {
	...
	private void initialize() {
		...
		mntmNewMenuItem.setIcon(new ImageIcon(GotPuzzledGUItest.class.getResource("/guiPackage/img/exit.png")));
		...
		mntmAboutGotPuzzled.setIcon(new ImageIcon(GotPuzzledGUItest.class.getResource("/guiPackage/img/info.png")));
